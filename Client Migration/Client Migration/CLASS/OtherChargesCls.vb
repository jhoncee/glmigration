...
Public Class OtherChargesCls
    ...
    Private Sub OtherChargesCls_PropertyChanged(sender As Object, e As PropertyChangedEventArgs) Handles Me.PropertyChanged
