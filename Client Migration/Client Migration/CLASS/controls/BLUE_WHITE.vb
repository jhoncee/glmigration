    ...
    Protected Overrides Sub OnResize(ByVal e As EventArgs)
        If Width > 0 AndAlso Height > 0 Then
            ...
            With Button
                ...
                .AddArc(Width - 11, 0, 10, 10, -90, 90)
                .AddArc(Width - 11, Height - 1, 10, 10, 0, 90)
                .CloseFigure()
            End With
            With Arrow1
    ...
    Protected Overrides Sub OnMouseDown(ByVal e As MouseEventArgs)
        If e.Button = MouseButtons.Left Then
            ...
            ElseIf OverCls Then
                FindForm.Close()
            Else
                If New Rectangle(FindForm.Location.X, FindForm.Location.Y, Width, 50).IntersectsWith(New Rectangle(MousePosition.X, MousePosition.Y, 1, 1)) AndAlso
...
#End Region
    ...
    Protected Overrides Sub OnMouseMove(ByVal e As MouseEventArgs)
        If Moveable AndAlso e.X > -1 AndAlso e.X < Width + 1 Then Value = _Minimum +
