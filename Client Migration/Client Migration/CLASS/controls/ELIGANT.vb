...
#Region "Draw Control"
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            .PixelOffsetMode = PixelOffsetMode.HighQuality
            .Clear(BackColor)
            Dim P() As Point = {New Point(0, 0), New Point(28, 0), New Point(28, Height / 2 - 6), New Point(34, Height / 2),
                               New Point(28, Height / 2 + 6), New Point(28, Height), New Point(0, Height)}
            Dim P1() As Point = {New Point(28, 0), New Point(28, Height / 2 - 6), New Point(34, Height / 2),
            ...
            ElseIf _Pictures = Pictures.Password Then
                ...
                Dim BaseKey() As Point = {New Point(18, 7), New Point(6, 18), New Point(6, 21), New Point(9, 21),
                                          New Point(9, 18), New Point(11, 19), New Point(10, 18), New Point(12, 18),
                                          New Point(11, 17), New Point(13, 17), New Point(12, 16), New Point(14, 16),
                                          New Point(13, 15), New Point(15, 15), New Point(15, 14), New Point(16, 14),
                                          New Point(15, 13)}
