    ...
    Protected Overrides Sub PaintHook()
        ...
        Select Case State
            Case MouseState.None
                ...
                DrawText(New SolidBrush(Color.FromArgb(1, 75, 124)), HorizontalAlignment.Center, 1, 1)
            Case MouseState.Down
                '// bnt form

                Dim linear As New LinearGradientBrush(New Rectangle(0, 0, Width, Height / 2), Color.FromArgb(100, Color.Blue), Color.FromArgb(250, 250, 250), 90.0F)
                Dim gp As New GraphicsPath
                gp = CreateRound(0, 0, Width - 1, Height - 1, 7)
                G.FillPath(linear, gp)
                G.DrawPath(New Pen(Color.FromArgb(105, 112, 115)), gp)
                ...
                DrawText(New SolidBrush(Color.FromArgb(86, 161, 196)), HorizontalAlignment.Center, 1, 1)

            Case MouseState.Over
                '// bnt form

                Dim linear As New LinearGradientBrush(New Rectangle(0, 0, Width, Height / 2), Color.FromArgb(100, Color.Green), Color.FromArgb(250, 250, 250), 90.0F)
                Dim gp As New GraphicsPath
                gp = CreateRound(0, 0, Width - 1, Height - 1, 7)
                G.FillPath(linear, gp)
                G.DrawPath(New Pen(Color.FromArgb(105, 112, 115)), gp)
